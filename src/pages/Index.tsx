...
import { Users, Globe, Zap, ArrowRight, Shield, HandCoins, CheckCircle } from 'lucide-react';
import { Link } from 'react-router-dom';
import { Button } from '@/components/ui/button';
import { InitiativeCard } from '@/components/InitiativeCard';

const Index = () => {
  const totalHeld = mockInitiatives.reduce((s, i) => s + i.heldAmount, 0);
  const featured = mockInitiatives.filter((i) => i.status === 'open').slice(0, 3);
