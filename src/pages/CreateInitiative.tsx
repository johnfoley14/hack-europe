...
import { AlertTriangle, MapPin, Info, Globe, Lock, Copy, Check } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen">
      <div className="container max-w-2xl py-8">
        ...
        {/* Warning banner */}
        <div className="flex items-start gap-3 rounded-xl bg-status-ending/10 border border-status-ending/20 p-4 mb-8">
          <AlertTriangle className="w-5 h-5 text-status-ending shrink-0 mt-0.5" />
          <div>
            <p className="text-sm font-medium text-foreground">Funds can only be held for up to 7 days</p>
            <p className="text-xs text-muted-foreground mt-0.5">Choose your deadline carefully. If the goal isn't reached by the deadline, all held funds will be released.</p>
          </div>
        </div>
